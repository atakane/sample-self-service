...
const pgApproveLeaveRequest = extend(Page)(
    ...
    function(_super) {
        ...
        // Lines
        SMFcomponents.createRectangle(this, 0, getUnit({iOS:'29.4152%',Android:'31.4152%'}), '100%', 1, '#e7e7e7');
        SMFcomponents.createRectangle(this, 0, getUnit({iOS:'40.8545%',Android:'42.8545%'}), '100%', 1, '#e7e7e7');
        SMFcomponents.createRectangle(this, 0, getUnit({iOS:'55.847%',Android:'57.847%'}), '100%', 1, '#e7e7e7');
    
        // Request Details
        SMFcomponents.createLabel(this, 'lblLeaveTypeText', 'LEAVE TYPE', '4.5333%', getUnit({iOS:'32.0389%',Android:'32.0389%'}), '40%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.LEFT, false, '7pt', false, '#248afd');
        SMFcomponents.createLabel(this, 'lblTimeUnitText', 'TIME UNIT', '60.4667%', getUnit({iOS:'32.0389%',Android:'32.0389%'}), '35%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.RIGHT, false, '7pt', false, '#248afd');
    
        SMFcomponents.createLabel(this, 'lblLeaveType', 'PERSONAL', '4.5333%', getUnit({iOS:'35.8508%',Android:'35.8508%'}), '40%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.LEFT, false, '10pt', false, '#4a4a4a');
        SMFcomponents.createLabel(this, 'lblTimeUnit', 'DAY', '60.4667%', getUnit({iOS:'35.8508%',Android:'35.8508%'}), '35%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.RIGHT, false, '10pt', false, '#4a4a4a');
    
        // Start Date
        SMFcomponents.createLabel(this, 'lblStart', 'STARTS', '4.5333%', getUnit({iOS:'42.5037%',Android:'44.5037%'}), '17%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.LEFT, false, '7pt', false, '#248afd');
        SMFcomponents.createLabel(this, 'lblStartDate', '-', '4.5333%', getUnit({iOS:'47.3013%',Android:'49.3013%'}), '37.3333%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.LEFT, false, '12pt', false, '#4a4a4a');
        SMFcomponents.createLabel(this, 'lblStartTime', '', '4.5333%', getUnit({iOS:'51.3013%',Android:'53.3013%'}), '29.2%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.LEFT, false, '8pt', false, '#4a4a4a');
        
        // End Date
        SMFcomponents.createLabel(this, 'lblEnd', 'ENDS', '80.4667%', getUnit({iOS:'42.5037%',Android:'44.5037%'}), '15%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.RIGHT, false, '7pt', false, '#248afd');
        SMFcomponents.createLabel(this, 'lblEndDate', '-', '60.4667%', getUnit({iOS:'47.3013%',Android:'49.3013%'}), '35%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.RIGHT, false, '12pt', false, '#4a4a4a');
        SMFcomponents.createLabel(this, 'lblEndTime', '', '60.4667%', getUnit({iOS:'51.3013%',Android:'53.3013%'}), '35%', getUnit({iOS:'2.9985%', Android:'5%'}), SMF.UI.TextAlignment.RIGHT, false, '8pt', false, '#4a4a4a');
        ...
        SMFcomponents.createContainer(this, 'cntDescriptionBack', 0, getUnit({iOS:'55.847%',Android:'57.847%'}), '100%', '44.153%', '#e7e7e7', false);
        SMFcomponents.createLabel(this, 'lblStart', 'DESCRIPTION', '4.4%', getUnit({iOS:'58.4707%',Android:'60.4707%'}), '63.3508%', '3%', SMF.UI.TextAlignment.LEFT, false, '7pt', false, '#248afd');
        ...
        this.updatePageObjects = function(oRequest) {
            ...
            this.imgAvatar.image = oRequest.Avatar;
