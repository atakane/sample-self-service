...
(function() {
    ...
    pgApprovalWorklist.add(lblNoData);
    ...
    function pgApprovalWorklist_onShow() {
        ...
        pgApprovalWorklist.sdSelfService.cntGeneral.cntTop.imgSliderAvatar.image = oProfile.Avatar;
        pgApprovalWorklist.sdSelfService.cntGeneral.cntTop.lblSliderFullName.text = oProfile.FullName;
        pgApprovalWorklist.sdSelfService.cntGeneral.cntTop.lblSliderTeamRole.text = oProfile.Role + ' / ' + oProfile.Team;
    ...
    function displayApprovalRequests(status) {
        ...
        */
        ...
        pgApprovalWorklist.lblNoData.visible = (arrayRequests.length == 0);
