/* globals mcs */
/* Based on Oracle MCS JavaScript SDK v2.0-16.2.3.0 (1mb), 2016-06-17 */
//"use strict";
...
var Platform = function() {
  ...
  this.getDeviceInformation = function() {
    // SMF edited
    return {
      "model": mcs.MobileBackendManager.platform.model,
      "manufacturer": mcs.MobileBackendManager.platform.manufacturer,
      "osName": mcs.MobileBackendManager.platform.osName,
      "osVersion": mcs.MobileBackendManager.platform.osVersion,
      "osBuild": mcs.MobileBackendManager.platform.osBuild,
      "carrier": mcs.MobileBackendManager.platform.carrier
    };
  };
